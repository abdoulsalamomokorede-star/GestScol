...
export default function EcoleFormModal({ isOpen, onClose, onSave }: EcoleFormModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md w-full bg-slate-950 border border-slate-800 text-slate-100 max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-lg font-bold text-slate-100">Ajouter un établissement</DialogTitle>
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-2">
            <Label htmlFor="school-nom" className="text-slate-300">Nom de l&apos;établissement *</Label>
            <Input
              id="school-nom"
              placeholder="Ex: GS Les Flamboyants"
              value={nom}
              onChange={(e) => setNom(e.target.value)}
              className="bg-slate-900 border-slate-800 focus:border-emerald-500 text-slate-100"
            />
            {errors.nom && (
          ...
          {/* Ville */}
          <div className="space-y-2">
            <Label htmlFor="school-ville" className="text-slate-300">Ville / Commune *</Label>
            <Input
              id="school-ville"
          ...
          {/* Adresse */}
          <div className="space-y-2">
            <Label htmlFor="school-adresse" className="text-slate-300">Adresse géographique complète</Label>
            <Input
              id="school-adresse"
          ...
          {/* Téléphone */}
          <div className="space-y-2">
            <Label htmlFor="school-telephone" className="text-slate-300">Téléphone de l&apos;école</Label>
            <Input
              id="school-telephone"
