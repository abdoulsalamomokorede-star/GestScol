  ...
  return (
    <div className="w-full max-w-4xl mx-auto py-8 sm:py-12 px-0 sm:px-6 lg:px-8">
      <div className="text-center space-y-4 mb-8 px-4">
        ...
        <h1 className="text-2xl sm:text-3xl font-display font-extrabold text-slate-900 tracking-tight sm:text-4xl">
          Fonctionnalité Premium
        </h1>
        <p className="text-base sm:text-lg text-slate-500 max-w-2xl mx-auto font-sans">
          Le module <strong className="text-primary font-bold">{title}</strong> n'est pas disponible dans la formule gratuite.
        </p>
      </div>

      <Card className="border border-primary/20 sm:border-2 shadow-xl bg-white overflow-hidden rounded-2xl">
        ...
        <CardContent className="p-4 sm:p-8 md:p-10 relative">
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 items-center">
            ...
            <div className="bg-slate-50 p-4 sm:p-6 md:p-8 rounded-2xl border border-slate-100 flex flex-col justify-center items-center text-center space-y-6">
              <div>
                <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Offre Recommandée</span>
                <h4 className="text-xl sm:text-2xl font-display font-extrabold text-slate-900 mt-1">Formule Standard</h4>
                <div className="mt-3 flex items-baseline justify-center">
                  ...
                  <span className="ml-1 text-lg sm:text-xl font-semibold text-slate-500 font-sans">FCFA / an</span>
                </div>
                <p className="text-[10px] text-slate-400 mt-2">Sans frais cachés, idéal pour les écoles primaires et secondaires</p>
              </div>
              ...
              <Link href="/support" className="text-[10px] sm:text-xs text-slate-500 hover:text-primary transition-colors hover:underline font-sans">
